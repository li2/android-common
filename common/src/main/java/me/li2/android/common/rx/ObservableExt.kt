...
fun <T> Observable<T>.throttleFirstShort() =
    this.throttleFirst(CLICK_THROTTLE_DELAY, TimeUnit.MILLISECONDS)!!

fun <T> Observable<T>.throttleFirstLong() =
    this.throttleFirst(CLICK_THROTTLE_DELAY_LONG, TimeUnit.MILLISECONDS)!!
